...
func (r *rest) routing() {
	...
	r.echo.GET("/champions", nil)
	r.echo.GET("/champions/:champion_name", nil)
	r.echo.GET("/champions/:champion_name/skins", nil)
	r.echo.GET("/champions/:champion_name/skins/:skin_name", nil)
